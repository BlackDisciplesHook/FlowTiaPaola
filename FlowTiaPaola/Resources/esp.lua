if not isfile("FlowTiaPaola/smallest_pixel-7.ttf") then
    writefile("FlowTiaPaola/smallest_pixel-7.ttf", game:HttpGet("https://github.com/cutelilfemboy12/Resources/raw/refs/heads/main/smallest_pixel-7.ttf"))
end
    ...
    name = "smallest_pixel-7", faces = {
        {
            ...
            weight = 400,
            style = "normal",
            assetId = getcustomasset("FlowTiaPaola/smallest_pixel-7.ttf")
        }
    }
}

writefile("FlowTiaPaola/smallest_pixel-7.font", game:GetService("HttpService"):JSONEncode(smallest_pixel))

if isfile("FlowTiaPaola/ProggyClean.ttf") then
    delfile("FlowTiaPaola/ProggyClean.ttf")
end

writefile("FlowTiaPaola/ProggyClean.ttf", game:HttpGet("https://github.com/cutelilfemboy12/Resources/raw/refs/heads/main/ProggyClean.ttf"))
    ...
    faces = {
        {
            ...
            weight = 400,
            style = "normal",
            assetId = getcustomasset("FlowTiaPaola/ProggyClean.ttf")
        }
    }
}

writefile("FlowTiaPaola/ProggyClean.font", game:GetService("HttpService"):JSONEncode(ProggyClean))
...
ESP.Init = function(Player)
    ...
    Drawings.Name = Utility.Create("TextLabel", {
        ...
        FontFace = Font.new(getcustomasset("FlowTiaPaola/" .. getgenv().GlobalFont), Enum.FontWeight.Regular),
    })
...
ESP.UpdateFonts = function()
    for _, Drawings in next, ESP.Drawings do
        Drawings.Name.FontFace = Font.new(getcustomasset("FlowTiaPaola/" .. getgenv().GlobalFont), Enum.FontWeight.Regular)
        Drawings.Distance.FontFace = Font.new(getcustomasset("FlowTiaPaola/" .. getgenv().GlobalFont), Enum.FontWeight.Regular)
    end
end
